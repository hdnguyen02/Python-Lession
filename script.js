const TRACKS = {
  python: {
    ...
    sidebarSub: "Python căn bản · 4 tuần",
    heroBadge: "📚 PYTHON căn bản",
    heroTitle: "PYTHON <span>căn bản</span>",
    heroDesc:
      "Học Python từ đầu — cú pháp, kiểu dữ liệu, collections, file, exceptions và OOP.",
    stats: { weeks: 4, milestones: 1 },
    phases: [
