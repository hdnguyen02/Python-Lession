const TRACKS = {
  python: {
    ...
    sidebarSub: "Python căn bản · 10 tuần",
    heroBadge: "📚 PYTHON căn bản",
    heroTitle: "PYTHON <span>căn bản</span>",
    heroDesc:
      "Học Python từ đầu — cú pháp, kiểu dữ liệu, collections, file, exceptions, OOP và xây dựng game thực chiến với Pygame.",
    stats: { weeks: 10, milestones: 3 },
    phases: [
    ...
    navLabels: {
      ...
      "p2-w5": "Tuần 5 · Git cơ bản",
      "p2-w6": "Tuần 6 · GitHub",
      "p2-milestone": "Bài tập lớn Phase 2",
      "p3-intro": "Giới thiệu · Flappy Bird",
      "p3-w7": "Tuần 7 · Pygame & Game Loop",
      "p3-w8": "Tuần 8 · Bird & Chuyển động",
      "p3-w9": "Tuần 9 · Pipe & Va chạm",
      "p3-w10": "Tuần 10 · Menu & Hoàn thiện",
      "p3-milestone": "Bài tập lớn Phase 3",
    },
  },
  typescript: {
    pageTitle: "PYTHON căn bản",
